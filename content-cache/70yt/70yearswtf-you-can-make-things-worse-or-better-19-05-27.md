---
title: "You can make things worse--or better"
collection: "70YearsWTF"
kind: "post"
order: 0
date: "2019-05-27"
author: "Mike Wolf"
original_url: "https://70yearswtf.substack.com/p/you-can-make-things-worse-or-better-19-05-27"
excerpt: "This morning I listened to a talk by Jordan Peterson that inspired me to write this post. I’ve linked to the video and downloaded the audio to produce a full transcript. (I’m also going to write a blog post on…"
word_count: 984
tags:
  - "70YearsWTF"
  - "AI"
...
This morning I listened to a talk by Jordan Peterson that inspired me to write this post. I’ve linked to [the video](https://www.youtube.com/watch?v=avInTfCd92Q) and downloaded the audio to produce [a full transcript](https://otter.ai/s/foB5YEjZREW37OEdmAOGTg). (I’m also going to write a blog post on how I did that).
...
It’s not that one ought to be disappointed when someone does not manifest the best in them, it’s that we *are* disappointed. The statement is descriptive rather than [normative](https://en.wikipedia.org/wiki/Normative) one.
