---
title: "Sex ratios and the value of the sexes"
collection: "70YearsWTF"
kind: "post"
order: 0
date: "2020-01-11"
author: "Mike Wolf"
original_url: "https://70yearswtf.substack.com/p/sex-ratios-and-the-value-of-the-sexes-20-01-11"
excerpt: "Continuing the series of posts toward addressing the problem “Does the economy treat women fairly” Evolution is damned clever, as I explained here and has repeatedly solved this problem: what’s the optimal sex ratio for a species. And what does…"
word_count: 1124
tags:
  - "70YearsWTF"
  - "meditation"
...
Continuing the [series](https://70yearsoldwtf.blogspot.com/2020/01/profound-knowledge-systems-and.html) [of](https://70yearsoldwtf.blogspot.com/2020/01/orgels-second-rule.html) [posts](https://70yearsoldwtf.blogspot.com/2020/01/a-meditation-on-fairness.html) toward addressing the problem “Does the economy treat women fairly”

Evolution is damned clever, as I explained [here](https://70yearsoldwtf.blogspot.com/2020/01/orgels-second-rule.html) and has repeatedly solved this problem: what’s the optimal sex ratio for a species. And what does evolution’s solution tell us about the relative values of the sexes?
...
The [human sex ratio](https://en.wikipedia.org/wiki/Human_sex_ratio) is

> slightly biased towards the male sex, being estimated to be about 1.05 or 1.06 males/per female born

Why should the [sex ratio at birth for most mammals](https://en.wikipedia.org/wiki/Sex_ratio) at be close to 1:1, but significantly different from 1:1? Why not closer to 1:1 than it is? A good answer is given by [Fisher’s principle](https://en.wikipedia.org/wiki/Fisher%27s_principle), which has been described as “probably the most celebrated argument in evolutionary biology.”

The argument comes from [Ronald Fisher](https://en.wikipedia.org/wiki/Ronald_Fisher)
...
Haven’t heard of him? He’s another one of my unsung heroes, like [Norman Borlaug](https://en.wikipedia.org/wiki/Norman_Borlaug) and [Vasily Arkhipov](https://en.wikipedia.org/wiki/Vasily_Arkhipov_(vice_admiral) and [Barry Marshall](https://en.wikipedia.org/wiki/Barry_Marshall) and [Robin Warren](https://en.wikipedia.org/wiki/Robin_Warren).

Among his other accomplishments, Fisher is known for developing the notion of statistical testing against the [Null hypothesis](https://en.wikipedia.org/wiki/Null_hypothesis). The Fisherian approach still prevails today despite the increasing use of [Bayesian statistics](https://en.wikipedia.org/wiki/Bayesian_statistics).

> [W.D. Hamilton](https://en.wikipedia.org/wiki/W.D._Hamilton) gave the following basic explanation in his 1967 paper on “Extraordinary sex ratios,” [[3]](https://en.wikipedia.org/wiki/Fisher%27s_principle#cite_note-Hamilton67-3) given the condition that males and females cost equal amounts to produce:
>
...
>
> In modern language, the 1:1 ratio is the [evolutionarily stable strategy](https://en.wikipedia.org/wiki/Evolutionarily_stable_strategy) (ESS).[[4]](https://en.wikipedia.org/wiki/Fisher%27s_principle#cite_note-MaynardSmithPrice73-4)
