...
excerpt: "After my junior year at MIT, I decided that I’d had it. I was off to see and save the world. The first part of the story, in which I hitchhiked to Chicago and spent a whole day looking for…"
word_count: 2114
tags:
  - "70YearsWTF"
related: []
...
In those days, “the circus” meant the one-of-a-kind [Ringling Brothers Barnum and Bailey Circus](https://www.ringling.com/) that played for weeks in big cities.

But that wasn’t the only circus around. There were a bunch of smaller circuses that played smaller towns, and as luck would have it, the [Mills Brothers’ Circus](http://www.circusesandsideshows.com/circuses/millsbroscircus.html) was right where I was—and looking for talent.
...
Mother John, the Internet tells me, was (Mother) John Makinson, who assisted John (Louisiana) Lewis and worked with John (Shorty) Walker. Don’t remember Louisiana or Shorty, but Mother John clearly left an impression on the internet. For more history, see [here](http://www.circushistory.org/Bandwagon/bw-1959Sep.htm).
...
Excerpted from [this document](https://docs.google.com/document/d/14I5Ida2WdBfUFr1C73O12ZsZ3JHS5C9xmp6NB7apTGY/edit)
