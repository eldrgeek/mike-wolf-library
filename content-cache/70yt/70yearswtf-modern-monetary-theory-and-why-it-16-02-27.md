---
title: "Modern Monetary Theory --  and why it matters"
...
excerpt: "Photo credit: free pictures of money via Foter.com / CC BY A while ago I tripped over an economic theory called \"Modern Monetary Theory (MMT).\" I thought is was interesting, and talked about it a bit, because, you know, weird…"
word_count: 4224
tags:
  - "70YearsWTF"
  - "economics"
...
A few days ago I came across a short book on the subject (Free PDF [here](http://moslereconomics.com/wp-content/powerpoints/7DIF.pdf), Amazon Kindle format just a buck, [here](http://www.amazon.com/Deadly-Innocent-Frauds-Economic-Policy-ebook/dp/B0092IUG00/ref=la_B009R8BA8W_1_1?s=books&ie=UTF8&qid=1456341865&sr=1-1)) It's written named [Warren Mosler](https://en.wikipedia.org/wiki/Warren_Mosler). He's an American broker, banker, economist, and sports car engineer.
...
> The **Hafele–Keating experiment** was a test of the [theory of relativity](https://en.wikipedia.org/wiki/Theory_of_relativity). In October 1971, [Joseph C. Hafele](https://en.wikipedia.org/wiki/Joseph_C._Hafele), a physicist, and [Richard E. Keating](https://en.wikipedia.org/wiki/Richard_E._Keating), an astronomer, took four cesium-beam [atomic clocks](https://en.wikipedia.org/wiki/Atomic_clock) aboard commercial airliners. They flew twice around the world, first eastward, then westward, and compared the clocks against others that remained at the [United States Naval Observatory](https://en.wikipedia.org/wiki/United_States_Naval_Observatory). When reunited, the three sets of clocks were found to disagree with one another, and their differences were consistent with the predictions of special and general relativity.

According to [this](http://scienceline.org/2010/10/do-frequent-fliers-age-more-slowly/) being a frequent flier is not a life-extension strategy. Fliers actually apparently age more quickly than folks on te ground. It just *seems* like the flight is taking forever.
...
Anyway, here are the links to book, I promised at the top (Remember? Free PDF [here](http://moslereconomics.com/wp-content/powerpoints/7DIF.pdf), Amazon Kindle format for a buck [here](http://www.amazon.com/Deadly-Innocent-Frauds-Economic-Policy-ebook/dp/B0092IUG00/ref=la_B009R8BA8W_1_1?s=books&ie=UTF8&qid=1456341865&sr=1-1).)
...
I'd apologize for the length of this piece, now around 4,100 words, but I'm too proud of it to apologize. Even if it's wrong I think it's a nice piece of writing. Thanks to writing advice [here](http://slatestarcodex.com/2016/02/20/writing-advice/) from my hero, Scott Alexander at [SlateStarCodex](http://slatestarcodex.com/).
