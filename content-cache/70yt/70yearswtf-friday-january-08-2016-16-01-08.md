...
excerpt: "A while ago I came across an article (here) that included this graphic: I checked the data and it passed the initial smell test, so I posted it to on the site of a discussion group that I belong to,…"
word_count: 193
tags:
  - "70YearsWTF"
related: []
...
That's just the beginning. Scott Alexander at Slate Star Codex has done a more complete analysis. [Link here](http://slatestarcodex.com/2016/01/06/guns-and-states/). It's worth reading, just to see how this sort of thing ought to be done.
