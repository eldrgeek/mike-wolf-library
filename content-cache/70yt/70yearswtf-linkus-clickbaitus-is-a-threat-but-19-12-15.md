---
title: "Linkus clickbaitus is a threat. But we can stop it."
collection: "70YearsWTF"
kind: "post"
order: 0
date: "2019-12-15"
author: "Mike Wolf"
original_url: "https://70yearswtf.substack.com/p/linkus-clickbaitus-is-a-threat-but-19-12-15"
excerpt: "Linkus clickbaitus, the common clickbait link, was unknown forty years ago. Now it’s rapidly filling its ecological niche, spawning fast-growing and fast-evolving varieties like L. clickbaitus outrageus, the outrage link, and L. clickbaitus memei, the common meme. Linkus clickbaitus While…"
word_count: 595
tags:
  - "70YearsWTF"
  - "economics"
...
Others disagree. “Linkus clickbaitus is a [behavior altering parasite](https://en.wikipedia.org/wiki/Behavior-altering_parasite),” says one.

> … behavioral altering parasites change the behavior of one of their [hosts](https://en.wikipedia.org/wiki/Host_(biology) “Host (biology)”) to facilitate their [transmission](https://en.wikipedia.org/wiki/Transmission_(medicine) “Transmission (medicine)”), They affecting the hosts’ decision-making and behavior control mechanisms in ways that harm the host, but help the parasite.

Mice infected by the protozoan _[Toxoplasma gondii](https://en.wikipedia.org/wiki/Toxoplasma_gondii) lose their fear of cats. Instead of hiding, the mice expose themselves. Cats kill them, eat them, and thus spread *Toxoplasma gondii* to more mice.

Viruses from the family _[Baculoviridae](https://en.wikipedia.org/wiki/Baculoviridae) make infected caterpillars eat incessantly, climb higher, then cause the caterpillar “cells secrete enzymes that ‘dissolve the animal into goo,’ raining down clumps of tissue and viral material for ingestion by future hosts.” [(Wikipedia)](https://en.wikipedia.org/wiki/Behavior-altering_parasite#By_viruses)
