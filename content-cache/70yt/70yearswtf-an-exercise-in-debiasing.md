...
My reading: there are two mechanisms at work: the facts and the [framing](https://en.wikipedia.org/wiki/Framing_(social_sciences)#:~:text=The%20effects%20of%20framing%20can,using%20the%20word%20fetus%20vs.).
...
Eric Weinstein points to one of the mechanisms in an [Edge.org article about Russell Conjugation](https://www.edge.org/response-detail/27181).
...
I copy/pasted the original article [in a Google Doc](https://docs.google.com/document/d/15jTyeVHGRLcIqi9HJhRUmvKvX22X_xFY5tnzGpew9_s/edit#heading=h.x3npfrj34qhg) and removed videos and images that did not render.
