---
title: "Dysfunction in the society of mind"
collection: "70YearsWTF"
kind: "post"
order: 0
date: "2014-12-09"
author: "Mike Wolf"
original_url: "https://70yearswtf.substack.com/p/dysfunction-in-the-society-of-mind-14-12-09"
excerpt: "Today I suffered an episode of mental decompensation. Decompensation is an eight dollar word for a breakdown. Mental decompensation sounds better than mental breakdown, but a breakdown is what it was. I found myself crying, for no reason that I…"
word_count: 1782
tags:
  - "70YearsWTF"
  - "AI"
...
Today I suffered an episode of mental decompensation. [Decompensation](http://en.wikipedia.org/wiki/Decompensation) is an eight dollar word for a breakdown. Mental decompensation sounds better than mental breakdown, but a breakdown is what it was.
...
The framework for my thinking comes from [Marvin Minsky’s](http://en.wikipedia.org/wiki/Marvin_Minsky) book [The Society of Mind](http://en.wikipedia.org/wiki/Society_of_Mind) (Wikipedia summary [here](http://en.wikipedia.org/wiki/Society_of_Mind), full text [here](http://aurellem.org/society-of-mind/) and MIT Open Courseware lecture [here](https://www.youtube.com/watch?v=-pb3z2w9gDg&list=PLUl4u3cNGP61E-vNcDV0w5xpsIBYNJDkU)). Minsky was one of the pioneers in AI, back in the 60s when computers first came on the scene and AI was not seen as the hard problem that it’s turned out to be.

The early thinking was that the mind was a computer and that creating artificial intelligence was just a matter of writing the right program. That’s true to the extent that any computational problem can be carried out by any computer or system that’s [Turing Complete](http://en.wikipedia.org/wiki/Turing_completeness). But more modern thinking about AI and about cognition in general views a mind not as a single computer, but as a collection of individually simple processes that Minsky called “agents.” The agents cooperate, collaborate, and sometimes compete. They operate in different ways, pursue different objectives and produce different solutions. Action is taken when some process, possibly involving other agents, intermediates between agents that solve problems and agents that control motor areas. And shit gets done.
...
Update: You can find the Society of Mind in pdf form [here](http://www.acad.bg/ebook/ml/Society%20of%20Mind.pdf).
