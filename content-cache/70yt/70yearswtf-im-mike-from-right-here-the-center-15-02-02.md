---
title: "I'm Mike, From Right Here, The Center of the Universe"
collection: "70YearsWTF"
kind: "post"
order: 0
date: "2015-02-02"
author: "Mike Wolf"
original_url: "https://70yearswtf.substack.com/p/im-mike-from-right-here-the-center-15-02-02"
excerpt: "Galaxies are so large that stars can be considered particles next to them (Photo credit: Wikipedia) During the first meeting of our Acadia Senior College class, referenced here, we were asked to each introduce ourselves, tell where we were from,…"
word_count: 609
tags:
  - "70YearsWTF"
  - "blogging"
...
During the first meeting of our Acadia Senior College class, referenced [here](http://70yearsoldwtf.blogspot.com/2015/01/the-problem-with-problem-with-god-lost.html/), we were asked to each introduce ourselves, tell where we were from, and say a little about ourselves. In subsequent meetings we'd each get a half-hour to talk about our own journey.
...
According to modern science, the origin story of the universe--and thus of each of us--is some variation of what's called the "[Big Bang Theory](http://en.wikipedia.org/wiki/Big_Bang)." According to the theory, the universe has not been around forever. We believe that started about 13.798 ± 0.037 billion years ago from a single point, and it's been expanding ever since. There's quite a bit of speculation about what happened during the first trillionth of a second, but after about 10−11 seconds, things are fairly well understood.
