---
title: "Birthday Activity--Part 1"
collection: "70YearsWTF"
kind: "post"
order: 0
date: "2017-12-31"
author: "Mike Wolf"
original_url: "https://70yearswtf.substack.com/p/birthday-activity-part-1-17-12-31"
excerpt: "Today I'm seventy-five. I started writing this at 4:51 PM. And by that time, here's what I had done. Yesterday, while making a list of things to write, I found this item: \"Angel (6) de la Cruz.\" That's the remembered name of someone I met…"
word_count: 1442
tags:
  - "70YearsWTF"
  - "- \"70YearsWTF"
...
Google is wonderful. I put in "Angel (6) de La Cruz" (including the quotes) and find [his LinkedIn profile](https://www.linkedin.com/in/angel-6-de-la-cruz-7a486740/?locale=en_US), and a [genealogy record](https://www.geni.com/people/Angel-6-de-la-Cruz-Silva/6000000036175387464) that tells us that "Angel 6 de la Cruz Silva" is the son of [Silvia (4) Silva Baez](https://www.geni.com/people/Sylvia-4-Silva-Baez/6000000036175753990), and a record at the [Elk's Club International](https://www.elks.org/enf/LodgeInfo.cfm?LodgeNumber=972) site that says Angel 6 De La Cruz Silva is the secretary for a Peurto Rican lodge, a [Twitter account for @a6d](https://twitter.com/a6d), and a [Facebook post](https://www.facebook.com/permalink.php?story_fbid=1573988419290020&id=128398093849067) from an Elk's lodge in the US reaching out to their brethren in Puerto Rico and mentioning Angel.
...
And a little time spent reading "[The Science of Doom](https://scienceofdoom.com/)." That's a blog that tries very hard to explain climate science. The comments are heavily moderated, resulting in a useful discussion of the content of the post, rather than partisan posturing of one kind or another. This morning I was reading about [atmospheric radiation and the greenhouse effect](https://scienceofdoom.com/2011/01/23/understanding-atmospheric-radiation-and-the-%E2%80%9Cgreenhouse%E2%80%9D-effect-%E2%80%93-part-two/), which I had misunderstood. No surprise: so had almost everything I had read.

Science of Doom has an article "[Confirmation Bias, a Feature, Not a Bug](https://scienceofdoom.com/2017/06/25/the-confirmation-bias-a-feature-not-a-bug/)" which I liked. The article quotes Jonathan Haidt:
...
Then Bobbi sends me a [review from The Intercept](https://theintercept.com/2017/12/24/star-wars-last-jedi-class-politics/) of the latest Star Wars movie. [The Intercept](https://en.wikipedia.org/wiki/The_Intercept) is "an online news publication dedicated to what it describes as, 'adversarial journalism'. One of the founders is [Glenn Greenwald](https://en.wikipedia.org/wiki/Glenn_Greenwald), well known for being the main point of contact for Edward Snowden's revelations. After reading the review I decide I want a T-shirt that says "Rebel Scum."

A bit more email, and I write an email to [Jared Golden](https://jaredgoldenforcongress.com/) who is will be running for the Maine 2 House seat and Jonathan Breed, his campaign manager, telling them to connect me up to like-minded volunteers. (I get an email back while I'm composing this, and spend a bit of time researching some stuff to reply to them.) But that's later.
...
We find out that Gil and Kiry are happy to have us, so we fine-tune the trip and consider alternative routes back. From LA? Through New Orleans and Panama City Beach? Or drive back.
...
So I compose a long email to the Pioneer Prize Group and suggest that we take a different tack: try to create a culture of innovation. Give kids a chance to see adults inventing things by organizing adults who already know how to make things and teaching adults who don't know how. To back it up I do a bunch of research on hardware: Raspberry Pi ($35.00 plus another $15 for a power supply) and other programmable computing devices (under $10 for a [LinkNode relay board](https://www.google.com/url?q=http%3A%2F%2Fwww.linksprite.com%2Fwiki%2Findex.php5%3Ftitle%3DLinkNode_R4%3A_Arduino-compatible_WiFi_relay_controller&sa=D&sntz=1&usg=AFQjCNFOlWxoUzFfVY-WICNRLE5hirH0SQ) with WiFi capability. What!) And I learn about Coding Clubs, a big thing in England, sponsored by the non-profit Raspberry Pi Foundation. There are more than 6,000 clubs in England (population about 60 million). So in Maine, there should be about 100 such. And there are probably none. I research Girls Who Code and see about the same, sad picture. And CoderDojo, another similar program.
...
Back to research where I find [CoderDojo](https://coderdojo.com/) and more [Girls Who Code](https://girlswhocode.com/) and [Code Club](https://www.codeclub.org.uk/) info and finally send out my email.
