---
title: "Sam Harris, on the AI threat"
...
Sam recently gave a [TED talk on AI](https://www.ted.com/talks/sam_harris_can_we_build_ai_without_losing_control_over_it?language=en). It's worth watching, before or after reading this.
...
Now imagine that we got a message that says " Hello! We are intelligent creatures from another galaxy. We will be landing on earth in large numbers in ten to one hundred years. And once we arrive we will "
...
And then what happens? No one has any idea.
...
> Our only hope is to evolve. But we’re always evolving. So let me be more specific.
>
> We can evolve by taking control of biological evolution, as noted above. And we can evolve in other dimensions.
>
> We can evolve by recognizing that the next step in evolution may be non-biological. I’ve long thought of AI as our “Silicon Children” and that may be part of how we evolve.
...
And not to diminish the issue, but only to put it in perspective—it's way more important than who's on the Supreme Court.
