...
Credit for the coinage should go to [one of my SBMs](https://70yearswtf.substack.com/p/sbm-and-dbf-19-05-23), Daniel. You can read [Daniel’s substack here](https://dcwolf.substack.com/p/coming-soon), as soon as he puts something there. He may have already.
...
## Confirmation Turtles is new idea.

Before I published this post, I did a [Google search for “Confirmation Turtles.”](https://www.google.com/search?q=%22confirmation+turtles%22&rlz=1CAOTWH_enUS907&oq=%22&aqs=chrome.0.69i59l3j69i57j35i39l6.1848j0j7&sourceid=chrome&ie=UTF-8) It yielded 129 results, I checked them out[1](#footnote-1). All coincidental.
...
Daniel gets the cred for coining it. I get some cred for injecting it into the [memosphere](https://en.wiktionary.org/wiki/memosphere). Memsphere is a novel (3500 search results), but not a new term.

(More details below)

## Details about Confirmation Turtles

Wikipedia says:

> **Confirmation Bias**is the tendency to search for, interpret, favor, and recall information in a way that confirms or supports one's prior [beliefs](https://en.wikipedia.org/wiki/Belief) or values.
