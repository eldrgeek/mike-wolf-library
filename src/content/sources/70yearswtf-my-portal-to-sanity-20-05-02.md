---
title: "My portal to sanity"
collection: "70YearsWTF"
kind: "post"
order: 0
date: "2020-05-02"
author: "Mike Wolf"
original_url: "https://70yearswtf.substack.com/p/my-portal-to-sanity-20-05-02"
excerpt: "My [quest to find portals](https://70yearswtf.substack.com/p/finding-a-portal-19-12-20) has led me to work on creating one. I call it my Portal to Sanity. Perhaps you can create your own. The need for a portal This post, [Building up to an…"
word_count: 1047
tags:
  - "70YearsWTF"
  - "- \"70YearsWTF"
...
My [quest to find portals](https://70yearswtf.substack.com/p/finding-a-portal-19-12-20) has led me to work on creating one. I call it my Portal to Sanity. Perhaps you can create your own.

## The need for a portal

This post, [Building up to an Internal Family Systems model](https://www.lesswrong.com/posts/5gfqG3Xcopscta3st/building-up-to-an-internal-family-systems-model) on Less Wrong, written by [Kaj Sotala](https://kajsotala.fi/about/), is a trail marker through the landscape of ideas that led me to create my portal. Perhaps it’s a good place for you to start. Or for Future Me to start, if he loses his way.

Kaja Sotala is a 33-year-old Finish [AI Researcher at the Future of Life Institute](https://futureoflife.org/ai-researcher-kaj-sotala/). I found him through this post, [Mental Mountains](https://slatestarcodex.com/2019/11/26/mental-mountains/), at SlateStarCodex. Scott says:
...
I haven’t read the book, but I found Kaj’s review interesting. It was based on work on [memory reconsolidation](https://en.wikipedia.org/wiki/Memory_consolidation), a phenomenon that I’d read about before. Memory reconsolidation research proposes that after a memory is reactivated memory, it needed to be rewritten into the nervous system, or the memory is lost. I read about a therapeutic modality called [Coherence therapy](https://en.wikipedia.org/wiki/Coherence_therapy) based on this idea.

About a thousand words into his essay, Kaj references [a post he wrote about Internal Family Systems](https://www.lesswrong.com/posts/5gfqG3Xcopscta3st/building-up-to-an-internal-family-systems-model). I jumped there and found he’d written an 8500-word essay. I’ve read it several times, and I am still learning from it.
