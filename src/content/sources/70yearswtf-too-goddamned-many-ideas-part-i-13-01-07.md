---
title: "Too Goddamned Many Ideas (Part I)"
collection: "70YearsWTF"
kind: "post"
order: 0
date: "2013-01-07"
author: "Mike Wolf"
original_url: "https://70yearswtf.substack.com/p/too-goddamned-many-ideas-part-i-13-01-07"
excerpt: "No idea exists in isolation. Every idea is part of a network of ideas that refer to each other, and sometimes to themselves (as this one is doing, right now). Expressing one idea is hard to do without having expressed the others on which…"
word_count: 901
tags:
  - "70YearsWTF"
  - "70YearsWTF"
...
**Science And Economics:**Economic forecasts are imprecise in part because the full power of the [scientific method](https://en.wikipedia.org/wiki/Scientific_method) can't be used to test some of the most important economic hypotheses. We can collect data and form hypotheses, but rigorous experiments are generally impossible. The result is that many [economic theories](https://en.wikipedia.org/wiki/Economics) are based on posthoc reasoning or imputing that correlation implies causation. Indeed, recent experiments in psychology have overturned many long-held economic principles.
...
**Wealth Produces Wealth:**Growing [national wealth](https://en.wikipedia.org/wiki/National_wealth) is important because, notwithstanding the fact that individuals can go from rags to riches or riches to rags in a generation, the current level of existing national, regional, family, and personal wealth* (as defined in **What Is Wealth***) predicts future wealth.
