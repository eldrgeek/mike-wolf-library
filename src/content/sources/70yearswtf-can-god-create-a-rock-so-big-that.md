...
excerpt: "![A surreal and philosophical depiction of the classic paradox: 'Can God create a rock so big that She can't move it?' The image shows a vast cosmic landscape with a divine, ethereal female figure, radiating celestial light, gazing at an…"
word_count: 769
tags:
  - "70YearsWTF"
  - "70YearsWTF"
...
> In [logic](https://en.wikipedia.org/wiki/Logic), the **law of excluded middle** or the **principle of excluded middle** states that for every [proposition](https://en.wikipedia.org/wiki/Proposition), [either](https://en.wikipedia.org/wiki/Exclusive_or) this proposition or its [negation](https://en.wikipedia.org/wiki/Negation) is [true](https://en.wikipedia.org/wiki/Truth_value).[[1]](https://en.wikipedia.org/wiki/Law_of_excluded_middle#cite_note-1)[[2]](https://en.wikipedia.org/wiki/Law_of_excluded_middle#cite_note-2) It is one of the [three laws of thought](https://en.wikipedia.org/wiki/Law_of_thought#The_three_traditional_laws), along with the [law of noncontradiction](https://en.wikipedia.org/wiki/Law_of_noncontradiction), and the [law of identity](https://en.wikipedia.org/wiki/Law_of_identity); however, no system of logic is built on just these laws, and none of these laws provides [inference rules](https://en.wikipedia.org/wiki/Rule_of_inference), such as [modus ponens](https://en.wikipedia.org/wiki/Modus_ponens) or [De Morgan's laws](https://en.wikipedia.org/wiki/De_Morgan%27s_laws). The law is also known as the **law** / **principle** **of the excluded third**, in [Latin](https://en.wikipedia.org/wiki/Latin) ***principium tertii exclusi***. Another Latin designation for this law is ***tertium non datur*** or "no third [possibility] is given". In [classical logic](https://en.wikipedia.org/wiki/Classical_logic), the law is a [tautology](https://en.wikipedia.org/wiki/Tautology_(logic)).
