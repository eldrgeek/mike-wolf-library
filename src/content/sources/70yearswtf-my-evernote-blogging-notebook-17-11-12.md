---
title: "My Evernote blogging notebook."
collection: "70YearsWTF"
kind: "post"
order: 0
date: "2017-11-12"
author: "Mike Wolf"
original_url: "https://70yearswtf.substack.com/p/my-evernote-blogging-notebook-17-11-12"
excerpt: "I've been an [Evernote](https://evernote.com/) user for a long time. Occasionally I pay them money for their premium version which I don't use. But I might someday. Like today. Maybe. Or maybe tomorrow. This is not an endorsement of…"
word_count: 486
tags:
  - "70YearsWTF"
  - "- \"70YearsWTF"
...
I've been an [Evernote](https://evernote.com/) user for a long time. Occasionally I pay them money for their premium version which I don't use. But I might someday. Like today. Maybe. Or maybe tomorrow.
...
Here's a link to [my blogging notebook](https://www.evernote.com/pub/wolfreporter/blogging). I wasn't able to create it using the web version of Evernote. Instead, I had to go to a Windows machine and download the Windows version of Evernote and do it there. Annoying. Why not make the web interface fully functional? Why not make it fast.
...
So [here's my initial design](https://70yearsoldwtf.blogspot.com/2017/11/an-evernote-alternative.html) for an Evernote Alternative.
