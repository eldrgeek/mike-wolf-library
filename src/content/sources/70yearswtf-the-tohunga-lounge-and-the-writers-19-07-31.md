---
title: "The Tohunga Lounge and the Writers Nook"
...
excerpt: "![](/media/70yt/the-tohunga-lounge-and-the-writers-19-07-31/1.jpg) Photo by [Aaron Burden](https://unsplash.com/@aaronburden?utmsource=unsplash&utmmedium=referral&utmcontent=creditCopyText) on…"
word_count: 1139
tags:
  - "70YearsWTF"
  - "70YearsWTF"
...
related:
  ...
  - "70yearswtf-modern-monetary-theory-explained-16-03-03"
---
...
A while back, my friend JL ran an experiment in community building. He’s a wicked smaht guy (as they say in Boston) and he knows other really smaht guys (and gals.) He set up a [Slack](https://slack.com/) workspace called the [Tohunga](https://en.wikipedia.org/wiki/Tohunga) Lounge (Tohunga is the term the [Māori](https://en.wikipedia.org/wiki/M%C4%81ori_people) people of [New Zealand](https://en.wikipedia.org/wiki/New_Zealand) use for “really smaht person.”) JL started posting interesting content and inviting the Tohungas he knew to join and contribute.
...
I have AMD, IDD, EIFID, and TMTOMHD. This toxic combination makes me hyper-vulnerable to intellectually seductive content. For those who don’t know these TLAs, FLAs and SLA’s: AMD is [Attention Management Disorder](https://70yearsoldwtf.blogspot.com/2015/01/attention-management-disorder.html), IDD is [Intention Deficit Disorder](https://70yearsoldwtf.blogspot.com/2016/10/intention-deficit-disorder.html) (each of which I’ve written about) EIFID is Everything Is Fucking Interesting Disorder, and TMTOMHD is Too Much Time On My Hands Disorder (about which I may write.)
...
When a person like me with AMD, IDD, EIFID, and TMTOMHD comes across something interesting (hint: everything is fucking interesting, due to EIFID) and since I know that my [purpose in life](https://70yearsoldwtf.blogspot.com/search?q=%22purpose+in+life%22) is [to create knowledge](https://70yearsoldwtf.blogspot.com/2017/07/the-purpose-of-universe-life-and-me.html) I’m easily sucked into a knowledge creation vortex. Step 1 is knowledge acquisition and Step 2, if I ever get to it is remixing what I’ve acquired, because Everything is a Remix ([video](https://vimeo.com/139094998), [site](https://www.everythingisaremix.info/)) and you need to acquire knowledge to remix it.
...
To deal with my AMD, IDD, EIFID, and TMTOMHD I quit reading Reddit (to which I am nonetheless indebted for [one of the best ideas I’ve come across](https://70yearsoldwtf.blogspot.com/2017/07/thank-you-past-me-thank-you-random.html)) and stop reading Twitter (which led me to [another really good idea](https://70yearsoldwtf.blogspot.com/2018/03/get-out-of-your-head-and-into-your-life.html)), and stop reading Facebook (link to a [page of photos of](https://www.flickr.com/photos/) .well, you can guess from the URL) (which has not yielded any ideas that I can recall and which still manages to waste time every time I go there to check on one of my kids who posts there) and I turned off my Google news feed (which about as much a waste of time as Facebook.)

And even though the quality was better than any of them, I stopped visiting the Tohunga Lounge. Sorry, JL.

## Tohunga 2.0

But now JL has launched Tohunga Lounge 2.0, hereinafter “TL2,” or “TL” or “the Lounge,” (as lawyers and pseudolawyers like me say.) TL2 is based on [Basecamp](https://basecamp.com/). I’ve used it before, and it’s a much better platform. I’m a big fan of founders [Jason Fried and DHH](https://basecamp.com/about) and who gave birth to a new way of running a business 20 years ago and who wrote [ReWork](https://www.amazon.com/dp/B002MUAJ2A/ref=dp-kindle-redirect?_encoding=UTF8&btkr=1)—a book about their business philosophy. DHH was a driving force behind [Ruby on Rails](https://rubyonrails.org/) and is the author of [this screed about business models](https://m.signalvnoise.com/reconsider/).
