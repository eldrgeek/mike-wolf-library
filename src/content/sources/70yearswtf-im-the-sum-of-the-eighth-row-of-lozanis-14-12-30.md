---
title: "I'm the sum of the eighth row of Lozanić's triangle years old! Yay?"
collection: "70YearsWTF"
kind: "post"
order: 0
date: "2014-12-30"
author: "Mike Wolf"
original_url: "https://70yearswtf.substack.com/p/im-the-sum-of-the-eighth-row-of-lozanis-14-12-30"
excerpt: "Yes, it's true. I'm 72. Besides being the sum of the eighth row of Lozanić's triangle, 72, my age, is: - the product of two consecutive numbers, 8 and 9. - the sum of four consecutive primes: (13 + 17 + 19 + 23). - the sum of six…"
word_count: 674
tags:
  - "70YearsWTF"
  - "70YearsWTF"
...
And a bunch of other stuff besides. Thanks [Wikipedia](http://en.wikipedia.org/wiki/72_%28number%29). And that reminded me to make my annual donation, and then to write a G+ post, which I'll quote below and then link to.
...
> Yes, there are politics involved. If there are people there will be politics. But the politics are (mostly) polite, and even though I am sure there are some bad actors the ethos of the community is to produce information that is written from a neutral point of view, with verifiable accuracy, citing reliable, authoritative sources:" ([http://en.wikipedia.org/wiki/Wikipedia:Five_pillars](http://en.wikipedia.org/wiki/Wikipedia:Five_pillars)) And that community standard, along with the ability to enforce the standard keeps the politics (mostly) healthy.
