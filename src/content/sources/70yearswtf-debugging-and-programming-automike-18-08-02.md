---
title: "Debugging and Programming AutoMike: Introduction"
collection: "70YearsWTF"
kind: "post"
order: 0
date: "2018-08-02"
author: "Mike Wolf"
original_url: "https://70yearswtf.substack.com/p/debugging-and-programming-automike-18-08-02"
excerpt: "A couple of weeks ago I woke to find myself standing in front of the refrigerator, with the door open, rummaging through it for something to eat. When I say “I woke” up, I don’t mean that I had been sleepwalking, other than in the…"
word_count: 1144
tags:
  - "70YearsWTF"
  - "70YearsWTF"
...
> According to [legend](https://www.computerworld.com/article/2515435/app-development/moth-in-the-machine--debugging-the-origins-of--bug-.html) the term “bug” as a reference to computer problems dates to a story told about the pioneering computer scientist [Grace Murry Hopper](https://en.wikipedia.org/wiki/Grace_Hopper) discovering that a particular computing problem was caused by a moth in one of the relays (relays?) for the computer. The predates computers and some claim it’s still in use rather than more accurate terms like “error” or “mistake” because we programmers make so many mistakes that we’d get depressed if we called them that. So we use the cutesy name “bug.” In safety-critical software, where such errors are intolerable they’re called “defects.” Bugs are cute. Errors are tolerable. Defects must be avoided and eliminated.
