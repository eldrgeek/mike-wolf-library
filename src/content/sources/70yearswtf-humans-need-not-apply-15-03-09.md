...
date: "2015-03-09"
author: "Mike Wolf"
original_url: "https://70yearswtf.substack.com/p/humans-need-not-apply-15-03-09"
excerpt: "CGP Grey is a dude who publishes awesome videos on YouTube. At the bottom of this post I've embedded the video that prompted this screed: about the coming of automation, and the problems it's going to present. Short form: people are going…"
word_count: 1383
tags:
  - "70YearsWTF"
  - "70YearsWTF"
...
> Economists apply the term "[Luddite fallacy](http://en.wikipedia.org/wiki/Technological_unemployment)" to the notion that [technological unemployment](http://en.wikipedia.org/wiki/Technological_unemployment) leads to [structural unemployment](http://en.wikipedia.org/wiki/Structural_unemployment) (and is consequently macroeconomically injurious). If a technological innovation results in a reduction of necessary labour inputs in a given sector, then the industry-wide cost of production falls, which lowers the competitive price and increases the equilibrium supply point which, theoretically, will require an increase in aggregate labour inputs.
