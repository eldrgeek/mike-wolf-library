---
title: "Inspiration not intention"
collection: "70YearsWTF"
kind: "post"
order: 0
date: "2017-01-06"
author: "Mike Wolf"
original_url: "https://70yearswtf.substack.com/p/inspiration-not-intention-17-01-06"
excerpt: "For years I've said that what I want to do is to \"live an intentional life.\" I want to decide what to do, form an intention, and follow through. That's it. But ADD or whatever-the-fuck-it-is gets in the way, and I end up doing things that…"
word_count: 922
tags:
  - "70YearsWTF"
  - "70YearsWTF"
...
A few weeks ago my daughter, Mira, found a book called "[The Miracle Morning](https://www.amazon.com/Miracle-Morning-Not-So-Obvious-Guaranteed-Transform/dp/0979019710/ref=sr_1_1?ie=UTF8&qid=1483721278&sr=8-1&keywords=miracle+mornings)" and started working on its recommended practices. She inspired me to give it a try: to create a different morning ritual for myself. To put some badly needed structure into my random and inconsistent self-improvement efforts

Get up early. Spend some time meditating. Well, I've wanted to do that for a while. But never could find a way to commit. Now I have it. And now I'm doing it. Ten minutes on affirmations. Strange, but I'm getting into it. Visualize what I want to achieve. Also weird, but, OK. Exercise. Badly needed. I started with my stationary bicycle--which I should have been doing for my knees. I've added a half hour during a day of the [30 days of Yoga with Adriene program to the mix](https://www.youtube.com/playlist?list=PLui6Eyny-UzwxbWCWDbTzEwsZnnROBTIL). The first day that I did it I realized how much I'd needed something like that. Reading: 10 minutes in a self-improvement book or reviewing one of those that I've already read, good. And writing. I've been doing that--sort of. Today was day 175 of my latest streak on [750words.com](http://750words.com/). I've done it diligently but at inconsistent times, a few times I've leaped from bed, changed my time zone, and struggled to type some shit that would qualify to keep the streak going. Now writing is part of my morning ritual.
