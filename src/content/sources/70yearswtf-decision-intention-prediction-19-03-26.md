---
title: "Decision, intention, prediction"
collection: "70YearsWTF"
kind: "post"
order: 0
date: "2019-03-26"
author: "Mike Wolf"
original_url: "https://70yearswtf.substack.com/p/decision-intention-prediction-19-03-26"
excerpt: "Here’s the bottom line for this post: Intention comes from decision. If an intention is strong enough, it will lead to action. To control action, start with decision, and test with prediction. Here’s how I got there: On October 21 I wrote…"
word_count: 539
tags:
  - "70YearsWTF"
  - "70YearsWTF"
...
On October 21 I wrote [this post](https://70yearsoldwtf.blogspot.com/2018/10/predicting-this-post-and-other-plans.html), about Predictive Processing and correctly predicted that I would publish it. On October 25, I wrote [this follow-up](https://70yearsoldwtf.blogspot.com/2018/10/todays-predictions.html) prediction. Then over the next 25 days, i published 21 posts.

Maybe there’s a connection. Perhaps not. But right now I’m going with maybe there is.

In some other posts, I wrote about intention. How intention makes things happen. But clearly ([as I considered here](https://70yearsoldwtf.blogspot.com/2019/02/intention-lost-intention-regained.html)) intention is not enough.
